    ...
    return schemas.AgentCard(
        ...
        skills=[
            schemas.AgentSkill(
                ...
                examples=["Create a pitch deck", "Make a 3-slide presentation on climate change"],
                inputModes=["text/plain"],
                outputModes=["application/vnd.openxmlformats-officedocument.presentationml.presentation"],
            ),
        ],
    )
